...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="<%=request.getContextPath()%>/RefreshFinesController?id=fineSearch"><img class="data-image" src="BookIcon.PNG" style="width:50px;height:50px;"></a>
    </div>
...
${message}<br>
<div class="container">
	<form class="form-horizontal" action="<%=request.getContextPath()%>/FineSearchController" method="post">
	<fieldset>
	<legend>Fine Search:</legend>
		<div class="form-group">
			<div class="col-sm-10">
				<input type="text" class="form-control" id="borrower_id" placeholder="Enter a Borrower ID or leave blank to search for all fines" name="borrower_id">
			</div>
		</div>
