...
${message}<br>
<div class="container">
	<form class="form-horizontal" action="<%=request.getContextPath()%>/CheckinSearchController" method="post">
	<fieldset>
	<legend>Book Check In:</legend>
		...
		<div class="form-group">
			<div class="col-sm-10">
				<input type="text" class="form-control" id="borrower_id" placeholder="Enter Borrower ID" name="borrower_id">
			</div>
		</div>
		<div class="form-group">
			<div class="col-sm-10">
				<input type="text" class="form-control" id="name" placeholder="Enter Borrower Name" name="name">
			</div>
		</div>
		<div class="form-group">        
			<div class="col-sm-10">
